...
export default function EditTourPackage() {
  const [price, setprice] = useState([10, 220, 320, 320, 230, 1310, 320, 320, 230])
    ...
    <CCard>
      <div className="container_tour">
        <div className="des_tour">
          <p className="tour_text">Edit Tour Package</p>
          <hr />
        </div>
          ...
          {daynight.day > 0 && (
            <div className="tb_body_tr">
              <table style={{ textAlign: 'center', color: 'gray', display: 'block' }}>
                <tbody>
                  <tr>
                    <th width="100px" className="tour_text">
                      Persons
                    </th>

                    <th width="500px" className="tour_text">
                      Tour Cost
                    </th>
                  </tr>
